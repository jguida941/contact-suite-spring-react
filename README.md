...
- PITest runs with conservative timeouts/threads; if you need to skip mutation testing locally, run `mvn verify -Dpit.skip=true`. CI automatically retries with `-Dpit.skip=true` should the mutation step hit an environment-specific failure.
